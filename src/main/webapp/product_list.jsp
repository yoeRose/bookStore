					...
					<table cellspacing="0" class="listcontent">
						<tr>
							<td>
								<h1>商品目录</h1>
								<hr />
								<h1>${category}</h1>&nbsp;&nbsp;&nbsp;&nbsp;共${pageResult.totalCount}种商品
								<hr />
										...
										<c:forEach items="${pageResult.list}" var="book">
											<td>
												<div class="divbookpic">
													<p>
														<a href="${pageContext.request.contextPath}/productInfo?id=${book.id}"><img src="${pageContext.request.contextPath}${book.imgurl}" width="115" height="129" border="0" /> </a>
													</p>
												</div>
